...
\noindent
A key feature of the distributed FLISR algorithm is to be in itself fault-tolerant, and therefore able to operate and produce results locally in the event that communication with the central,
