...
FLISR as well as those that require human intervention. A key concern identified is the need to ensure such grid resiliency solutions are in themselves fault-tolerant and therefore not dependent on centralised
...
\\
In realising a distributed FLISR solution then, edge computing emerges as an ideal paradigm to implement this functionality.
