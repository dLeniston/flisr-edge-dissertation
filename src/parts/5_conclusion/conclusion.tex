...
\\
The research undertaken to meet this need utilises modern software and communication technologies, leveraging existing DSO data streams, to provide such a solution in a fault tolerant way by
implementing a FLISR application which can operate both remotely and at the edge of the network by applying edge computing techniques.
By automating this process, the time of detection and resolution of fault events
is minimal, as demonstrated by the results gathered. This grants the potential reduction of the financial impact of fault events, and the level of
customers affected. The development of a simulation platform which provides an intuitive interface to create and test fault events on real distribution grids, enables a pathway
...
the energy market enable intelligent energy flexibility to meet the demands on increased RES, distributed energy sources and prosumer activities.
